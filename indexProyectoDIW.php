...
<html lang="es">
    ...
    <body>
        ...
        <footer class="piepagina">
            ...
            <a href="https://github.com/AlbertoFRSauces/proyectoDAW/tree/master/proyectoDIW" target="_blank"><img href="https://github.com/AlbertoFRSauces/proyectoDAW/tree/master/proyectoDIW" target="_blank" src="../webroot/css/img/github.png" class="imagegithub" alt="IconoGitHub" /></a>
